...
Сделать регистрацию сервиса текущего пользователя (взять пользователь системы). Добавить Web.config для log4net, после ухода от log4net Web.config будет не нужен.
