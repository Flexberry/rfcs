...
> 2.	По факту-изменению вычитывается аудит-изменения объекта. Из аудита-изменения восстанавливается состояние объекта.
...
> * Получение состояния объекта на дату.
