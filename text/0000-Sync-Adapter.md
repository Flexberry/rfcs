...
Поэтому адаптер должен обладать следующими возможностями:
...
6. предоставлять возможность реализации различных способов взаимодействия между приложениями ([технологическая шина](http://nuget.ics.perm.ru/packages/NewPlatform.Flexberry.HighwaySB), прямое подключения БД-приёмника и другие)
